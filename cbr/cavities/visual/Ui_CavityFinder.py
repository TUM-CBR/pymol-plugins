...
class Ui_CavityFinder(object):
    def setupUi(self, CavityFinder):
        ...
        self.gridLayout.addItem(spacerItem, 1, 12, 1, 4)
        ...
        self.gridLayout.addWidget(self.selectionDistance, 3, 3, 1, 1)
...
"font-weight: bold;")
        ...
        self.gridLayout.addWidget(self.advancedSettingsButton, 1, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.busyProgress, 4, 0, 1, 15)
        ...
        self.gridLayout.addWidget(self.opacitySlider, 3, 5, 1, 11)
