...
class Ui_KineticsOptimizer(object):
    def setupUi(self, KineticsOptimizer):
        ...
        KineticsOptimizer.resize(773, 522)
...
"font-weight: bold;")
        ...
        self.tableView = QtWidgets.QTableView(KineticsOptimizer)
        ...
        self.gridLayout.addWidget(self.initalValuesWidget, 1, 0, 1, 1)
        self.plotWidget = QtWidgets.QWidget(KineticsOptimizer)
        self.plotWidget.setObjectName("plotWidget")
        self.gridLayout.addWidget(self.plotWidget, 4, 0, 1, 2)
