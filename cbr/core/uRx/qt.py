...
class QtRx:
    ...
    def observe_signal(
        ...
        return Dsl(observer_from_signal(parent, signal, slot_args=slot_args), DslContext())
    ...
    def foreach_signal(
        ...
        return cls.observe_signal(parent, signal, slot_args=slot_args).subscribe(cls.foreach_ui_observer(parent, action))
