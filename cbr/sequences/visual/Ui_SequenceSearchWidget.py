...
"font-weight: bold;")
        ...
        self.gridLayout.addWidget(self.searchButton, 2, 5, 1, 1)
        self.rescanButton = QtWidgets.QPushButton(SequenceSearchWidget)
        self.rescanButton.setObjectName("rescanButton")
        self.gridLayout.addWidget(self.rescanButton, 2, 4, 1, 1)
        self.showErrorsButton = QtWidgets.QPushButton(SequenceSearchWidget)
        self.showErrorsButton.setObjectName("showErrorsButton")
        self.gridLayout.addWidget(self.showErrorsButton, 2, 3, 1, 1)
    ...
    def retranslateUi(self, SequenceSearchWidget):
        ...
        self.showErrorsButton.setText(_translate("SequenceSearchWidget", "Show Errors"))
